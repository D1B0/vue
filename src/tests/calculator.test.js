...
describe('Calculator Test', () => {
    it('sum test', () => {
        ...
        it('checkbox keyboard test', () => {
            ...
            keyboardWindowButton.trigger('click')
            expect(wrapper.vm.operand1).toBe(12345)

            keyboardWindowButton = wrapper.find('button[name="6"]')
            keyboardWindowButton.trigger('click')
            expect(wrapper.vm.operand1).toBe(123456)

            keyboardWindowButton = wrapper.find('button[name="7"]')
            keyboardWindowButton.trigger('click')
            expect(wrapper.vm.operand1).toBe(1234567)
